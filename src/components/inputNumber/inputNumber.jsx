...
export default {
  ...
  render() {
    ...
    const suffixNode =
      this.$slots.suffix ||
      (suffix ? <div class="u-input-number-suffix">{suffix}</div> : null);
    return (
      <BaseInput {...props}>
        <template slot="suffix">
          {suffixNode}
          {controls ? (
            <div class="u-input-number-controls">
              <span
                class="u-input-number-control"
                onClick={() => this.setVal(1)}
              >
                <Icon type="chevron-up" />
              </span>
              <span class="u-input-number-control" onClick={this.setVal}>
                <Icon type="chevron-up" />
              </span>
            </div>
          ) : null}
