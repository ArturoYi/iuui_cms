...
let { Sync, IconImage } = { Sync: "sync", IconImage: "icon-image" };
export default {
  name: "UImage",
  props: {
    alt: String,
    ...
    return (
      <div {...props}>
        ...
        {(!showImg || error) && !placeholder ? (
          <Icon type={IconImage} class="u-image-error" />
        ) : null}
        {loading ? (
          <div class="u-image-loading" key="wocao">
            <Icon type={Sync} spin class="u-image-loading-icon" />
          </div>
        ) : null}
        {this.$slots.default}
      </div>
