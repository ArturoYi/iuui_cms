...
export default {
  ...
  methods: {
    ...
    rendreBody() {
      ...
      for (let tr in rows) {
        // console.log(tr)
        trs.push(<tr class="u-descriptions-row">{rows[tr]}</tr>);
      }
  ...
  render() {
    ...
    let props = {
      class: [
        "u-descriptions",
        {
          "u-descriptions-vertical": layout == "vertical",
          "u-descriptions-bordered": bordered,
          "u-descriptions-middle": size == "middle",
          "u-descriptions-sm": size == "small",
        },
      ],
    };
    ...
    return (
      <div {...props}>
        <div class="u-descriptions-header">
          <div class="u-descriptions-title">{title || $slots.title}</div>
          {extra ? <div class="u-descriptions-extra">{extra}</div> : null}
        </div>
        <div class="u-descriptions-view">{this.rendreBody()}</div>
      </div>
    );
  },
};
