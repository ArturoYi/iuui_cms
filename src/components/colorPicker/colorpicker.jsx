...
export default {
  ...
  methods: {
    ...
    valueChange(prop, value) {
      switch (prop) {
        case "COLOR":
          [this.R, this.G, this.B, this.A] = parseColor(value, "rgba") || [
            0, 0, 0, 1,
          ];
    ...
    updateValue() {
      let { currentMode, R, G, B, A, H, S, L } = this,
        value = null;
      if (currentMode == "hex") {
        value = this.HEX;
          ...
          input: (e) => {
            ...
            if (key == "HEX") {
              ...
              if (/^#([0-9A-F]{6}|[0-9A-F]{3}|[0-9A-F]{8})$/i.test(value)) {
                [this.R, this.G, this.B, this.A] = cssColorToRgba(value) || [
                  this.R,
                  this.G,
                  this.B,
                  this.A,
    ...
    renderValue() {
      if (this.showMode) {
        let { currentMode, renderValueInput } = this,
          node = [];
        if (currentMode == "rgba") {
          let keys = ["R", "G", "B", "A"];
          let v = (
            <div class="u-color-picker-val">
              {keys.map((k) => renderValueInput(k))}
            </div>
          );
          let k = (
            <div class="u-color-picker-key">
              {keys.map((k) => (
                <span>{k}</span>
              ))}
            </div>
          ...
          //hex
          let v = (
            <div class="u-color-picker-val">{renderValueInput("HEX")}</div>
          );
          let k = (
            <div class="u-color-picker-key">
              <span>HEX</span>
        ...
        node.push(btn);
        return (
          <div class={`u-color-picker-mode u-color-picker-${currentMode}`}>
            {node}
          </div>
        );
      }
    ...
    renderDefaultColor() {
      let color = this.defalutColors.map((c) => (
        <span
          style={"background-color:" + c}
          onClick={(e) => this.valueChange("COLOR", c)}
        ></span>
      ));
      let okBtn = (
        <Button circle onClick={this.updateValue}>
          OK
        </Button>
      );
      return <div class="u-coclor-picker-defaults">{[color, okBtn]}</div>;
    },
    renderDrop() {
      ...
      const props = {
        ...
        props: {
          ...
          value: this.opened,
          selection: this.$el,
          className: "u-color-picker-dropdown",
          transitionName: "u-color-picker",
        },
        on: {
          input: (e) => {
            this.opened = e;
      ...
      return (
        <Drop {...props}>
          {paint}
          <span
            class="u-color-picker-paint-dot"
            style={
              "left:" +
              this.paintPointer.x +
              "px;top:" +
          ...
          ></span>
          <div class="u-color-picker-bar">
            <div class="u-color-picker-avatar">
              <div
                class="u-color-picker-avatar-inner"
                style={`background-color:rgba(${this.R}, ${this.G}, ${this.B}, ${this.A})`}
              ></div>
            </div>
            <div class="u-color-picker-bar-box">
              {[hue, alpha]}
              <span
                class="u-color-picker-hue-dot"
                style={"left:" + this.huePointer.x + "px"}
              ></span>
              <span
                class="u-color-picker-alpha-dot"
  ...
  render() {
    ...
    let style = [
      "u-color-picker",
      {
        "u-color-picker-disabled": this.disabled,
        "u-color-picker-sm": this.size == "small",
        "u-color-picker-circle": this.shape == "circle" && !showArrow,
        "u-color-picker-lg": this.size == "large",
      },
    ];

    return (
      <div class={style}>
        <div class="u-color-picker-selection" onClick={this.toggleDrop}>
          <div class="u-color-picker-color">
            <div
              class="u-color-picker-color-inner"
